...
pub mod secp256k1 {
    use openzeppelin::tests::test_utils::signing::{Secp256k1KeyPair, get_secp256k1_keys_from};
...
pub mod stark {
    use openzeppelin::tests::test_utils::signing::{StarkKeyPair, get_stark_keys_from};
